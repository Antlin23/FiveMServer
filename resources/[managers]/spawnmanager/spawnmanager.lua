...
function spawnPlayer(spawnIdx, cb)
    ...
    Citizen.CreateThread(function()
        ...
        -- get the spawn from the array or use hardcoded spawn
        local spawn
        ...
        elseif spawnIdx then
            -- If a specific spawn index is provided, use it
            spawn = spawnPoints[spawnIdx]
        else
            -- Always use hardcoded spawn coordinates
            spawn = hardcodedSpawn
        end
