Citizen.CreateThread(function()
	while true do
		...
		SetPedDensityMultiplierThisFrame(0.8) -- set npc/ai peds density
		...
		SetScenarioPedDensityMultiplierThisFrame(1, 1) -- set random npc/ai peds or scenario peds
		SetGarbageTrucks(false) -- Stop garbage trucks from randomly spawning
		SetRandomBoats(true) --random boats from spawning in the water.
